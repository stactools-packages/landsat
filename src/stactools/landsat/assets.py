...
class AssetDef:
    ...
    def add_asset(
        self, item: pystac.Item, mtl_metadata: MtlMetadata, base_href: str
    ) -> None:
        asset = pystac.Asset(href=self.get_href(base_href), media_type=self.media_type)
        if self.title:
...
THUMBNAIL_ASSET_DEF = AssetDef(
    key="thumbnail",
    href_suffix="thumb_small.jpeg",
    title="Thumbnail image",
    media_type=pystac.MediaType.JPEG,
)
PREVIEW_ASSET_DEF = AssetDef(
    key="reduced_resolution_browse",
...
B1_ASSET_DEF = AssetDef(
    ...
    description=(
        "Collection 2 Level-2 Coastal/Aerosol Band " "(B1) Surface Reflectance"
    ),
    media_type=pystac.MediaType.COG,
    is_sr=True,
)
B2_ASSET_DEF = AssetDef(
...
QA_AEROSOL_ASSET_DEF = AssetDef(
    ...
    description=(
        "Collection 2 Level-2 Aerosol Quality Analysis Band "
...
ST_ATRAN_ASSET_DEF = AssetDef(
    ...
    description=(
        "Landsat Collection 2 Level-2 Atmospheric "
...
ST_CDIST_ASSET_DEF = AssetDef(
    ...
    description=(
        "Landsat Collection 2 Level-2 Cloud Distance Band "
...
ST_DRAD_ASSET_DEF = AssetDef(
    ...
    description=(
        "Landsat Collection 2 Level-2 Downwelled "
...
ST_URAD_ASSET_DEF = AssetDef(
    ...
    description=(
        "Landsat Collection 2 Level-2 Upwelled "
        "Radiance Band Surface Temperature Product"
    ),
    media_type=pystac.MediaType.COG,
    is_thermal=True,
...
ST_EMSD_ASSET_DEF = AssetDef(
    ...
    description=(
        "Landsat Collection 2 Level-2 Emissivity "
